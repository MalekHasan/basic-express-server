...
In middlewares i create a ***logger.js*** which is log the ***path(route or endpoint)*** of the routing process and the ***HTTP method (GET , POST , DELETE ...etc)*** that we used to hit the route.  
